...
/**
 * ListBpayAccountsBpayDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListBpayAccountsBpayDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'list_bpay_accounts_bpay_details';
     ...
     * Sets account_name
     *
     * @param string|null $account_name Name assigned by the platform/marketplace to identify the account (similar to a nickname)
     *
     * @return self
     */
     ...
     * Sets biller_code
     *
     * @param int|null $biller_code biller_code
     *
     * @return self
     */
     ...
     * Sets biller_name
     *
     * @param string|null $biller_name Name of the biller as registered in BPay
     *
     * @return self
     */
