...
/**
 * CardAccountRequestBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CardAccountRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'card_account_requestBody';
    ...
    {
        $this->container['full_name'] = $data['full_name'] ?? 'John Doe';
        $this->container['number'] = $data['number'] ?? '4444111122223333';
        $this->container['expiry_month'] = $data['expiry_month'] ?? null;
        $this->container['expiry_year'] = $data['expiry_year'] ?? null;
        $this->container['cvv'] = $data['cvv'] ?? '123';
        $this->container['user_id'] = $data['user_id'] ?? '83f54680-9600-4bee-a6d1-84a5d0e10059';
    }
     ...
     * Sets full_name
     *
     * @param string $full_name User full name with at least a space
     *
     * @return self
     */
     ...
     * Sets expiry_month
     *
     * @param int $expiry_month Expiry month (MM)
     *
     * @return self
     */
     ...
     * Sets expiry_year
     *
     * @param int $expiry_year Expiry year (YYYY)
     *
     * @return self
     */
