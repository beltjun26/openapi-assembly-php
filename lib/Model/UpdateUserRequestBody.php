 ...
 */
class UpdateUserRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_user_requestBody';
     ...
     * Sets email
     *
     * @param string|null $email Email of the user. Unique to platform.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country [ISO 3166-1 alpha-3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3#Officially_assigned_code_elements) country code (3 char)
     *
     * @return self
     */
